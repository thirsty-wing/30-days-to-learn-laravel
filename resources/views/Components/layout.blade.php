        ...
        <nav class="bg-gray-800">
            ...
            <div class="md:hidden" id="mobile-menu">
                <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
                    ...
                    <a href="/jobs"
                        class="block px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white rounded-md">Jobs</a>
                    <a href="/contact"
                        class="block px-3 py-2 text-base font-medium text-gray-300 hover:bg-gray-700 hover:text-white rounded-md">Contact</a>
                </div>
